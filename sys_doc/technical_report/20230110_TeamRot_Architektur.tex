...
Als Framework wird hierfür FastAPI genutzt, welches als Sprache Python verwendet. Durch das verwendete Framework wurde eine REST-API verwirklicht, welche durch das Frontend angesprochen werden kann.
...
\end{itemize}
Des Weiteren wird als Test-Framework im Backend Pytest genutzt.
